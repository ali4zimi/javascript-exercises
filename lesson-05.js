...
function pricingFunction(orderSize) {
  if (orderSize > 12) {
    console.log("Large order, call the bakery ahead");
  } else if (orderSize > 6) {
    console.log("Medium order, ready in an hour");
...
const pricingFunctionWithReturn = function(orderSize = 5) {
  if (orderSize > 12) {
...
console.log(pricingFunctionWithReturn(14));
console.log(pricingFunctionWithReturn(10));
console.log(pricingFunctionWithReturn(5));
console.log(pricingFunctionWithReturn(1));

// The returning version is more reusable because it allows the caller to decide what to do with the message, 
// such as logging it, storing it, or using it in further logic.
...
// * The pricing function with a default parameter value:
const pricingFunctionWithDefault = function(orderSize = 5) {
  if (orderSize > 12) {
    return "Large order, call the bakery ahead";
  } else if (orderSize > 6) {
    return "Medium order, ready in an hour";
...
console.log(pricingFunctionWithDefault(14));
console.log(pricingFunctionWithDefault());
...
// console.log(insideIf); // prediction first, then uncomment to verify: reference error 
...
const celsiusToFahrenheit = (celsius) => (celsius * 9/5) + 32 + " Fahrenheit";
const fahrenheitToCelsius = (fahrenheit) => (fahrenheit - 32) * 5/9 + " Celsius";

console.log("Celsius to Fahrenheit:");
console.log(`${0} Celsius = ${celsiusToFahrenheit(0)}`);
console.log(`${25} Celsius = ${celsiusToFahrenheit(25)}`);
console.log(`${100} Celsius = ${celsiusToFahrenheit(100)}`);

console.log("Fahrenheit to Celsius:");
console.log(`${32} Fahrenheit = ${fahrenheitToCelsius(32)}`);
console.log(`${77} Fahrenheit = ${fahrenheitToCelsius(77)}`);
console.log(`${212} Fahrenheit = ${fahrenheitToCelsius(212)}`);
